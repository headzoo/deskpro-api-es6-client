...
* @module DeskPRO\API/Model/GenNotificationType
* @version 2.0.0
*/
export default class GenNotificationType {
    /**
    * Constructs a new <code>GenNotificationType</code>.
    * @alias module:DeskPRO\API/Model/GenNotificationType
    * @class
    */
    ...
    * @param {module:DeskPRO\API/Model/GenNotificationType} obj Optional instance to populate.
    * @return {module:DeskPRO\API/Model/GenNotificationType} The populated <code>GenNotificationType</code> instance.
    */
