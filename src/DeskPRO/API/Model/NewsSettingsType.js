...
* @module DeskPRO\API/Model/NewsSettingsType
* @version 2.0.0
*/
export default class NewsSettingsType {
    /**
    * Constructs a new <code>NewsSettingsType</code>.
    * @alias module:DeskPRO\API/Model/NewsSettingsType
    * @class
    */
    ...
    * @param {module:DeskPRO\API/Model/NewsSettingsType} obj Optional instance to populate.
    * @return {module:DeskPRO\API/Model/NewsSettingsType} The populated <code>NewsSettingsType</code> instance.
    */
