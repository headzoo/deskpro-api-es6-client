...
* @module DeskPRO\API/Model/KbSettingsType
* @version 2.0.0
*/
export default class KbSettingsType {
    /**
    * Constructs a new <code>KbSettingsType</code>.
    * @alias module:DeskPRO\API/Model/KbSettingsType
    * @class
    */
    ...
    * @param {module:DeskPRO\API/Model/KbSettingsType} obj Optional instance to populate.
    * @return {module:DeskPRO\API/Model/KbSettingsType} The populated <code>KbSettingsType</code> instance.
    */
