...
* @module DeskPRO\API/Model/GeneralSettingsType
* @version 2.0.0
*/
export default class GeneralSettingsType {
    /**
    * Constructs a new <code>GeneralSettingsType</code>.
    * @alias module:DeskPRO\API/Model/GeneralSettingsType
    * @class
    */
    ...
    * @param {module:DeskPRO\API/Model/GeneralSettingsType} obj Optional instance to populate.
    * @return {module:DeskPRO\API/Model/GeneralSettingsType} The populated <code>GeneralSettingsType</code> instance.
    */
