...
export default class AgentChatMessageType {
    ...
    * @param {module:model/AgentChatMessageType} obj Optional instance to populate.
    * @return {module:model/AgentChatMessageType} The populated <code>AgentChatMessageType</code> instance.
    */
