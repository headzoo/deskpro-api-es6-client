...
export default class CaptchaAntiAbuseType {
    ...
    * @param {module:model/CaptchaAntiAbuseType} obj Optional instance to populate.
    * @return {module:model/CaptchaAntiAbuseType} The populated <code>CaptchaAntiAbuseType</code> instance.
    */
