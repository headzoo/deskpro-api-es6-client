...
export default class TaskCommentType {
    ...
    * @param {module:model/TaskCommentType} obj Optional instance to populate.
    * @return {module:model/TaskCommentType} The populated <code>TaskCommentType</code> instance.
    */
