...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DeskProApi.GuideType();
  });
  ...
  describe('GuideType', function() {
    it('should create an instance of GuideType', function() {
      // uncomment below and update the code to test GuideType
      //var instane = new DeskProApi.GuideType();
      //expect(instance).to.be.a(DeskProApi.GuideType);
    });
