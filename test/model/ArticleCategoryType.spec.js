...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DeskProApi.ArticleCategoryType();
  });
  ...
  describe('ArticleCategoryType', function() {
    it('should create an instance of ArticleCategoryType', function() {
      // uncomment below and update the code to test ArticleCategoryType
      //var instane = new DeskProApi.ArticleCategoryType();
      //expect(instance).to.be.a(DeskProApi.ArticleCategoryType);
    });
