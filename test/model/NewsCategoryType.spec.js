...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DeskProApi.NewsCategoryType();
  });
  ...
  describe('NewsCategoryType', function() {
    it('should create an instance of NewsCategoryType', function() {
      // uncomment below and update the code to test NewsCategoryType
      //var instane = new DeskProApi.NewsCategoryType();
      //expect(instance).to.be.a(DeskProApi.NewsCategoryType);
    });
