...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new DeskProApi.GlossaryWordType();
  });
  ...
  describe('GlossaryWordType', function() {
    it('should create an instance of GlossaryWordType', function() {
      // uncomment below and update the code to test GlossaryWordType
      //var instane = new DeskProApi.GlossaryWordType();
      //expect(instance).to.be.a(DeskProApi.GlossaryWordType);
    });
