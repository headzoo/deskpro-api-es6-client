...
let apiInstance = new DeskProApi.TasksApi();
...
apiInstance.deleteTaskByParentIdCommentById(id, parentId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.getTaskByParentIdComment(parentId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.getTaskByParentIdCommentById(id, parentId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.getTaskByParentIdCommentCount(parentId, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
