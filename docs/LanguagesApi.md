...
let apiInstance = new DeskProApi.LanguagesApi();

apiInstance.getLanguageAdminPhrase((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.getLanguageAgentPhrase((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.getLanguageById(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.getLanguageCount((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
